...
namespace rwc
{
    ...
    private:
        ...
        bool try_enable_hardware_decoding(void* attribs, void** d3d_device_out, void** dxgi_manager_out);
        void mmf_capture_thread(std::stop_token token);
        webcam_error_status decode_frame_to_bgr24(void* sample, void** buffer);
